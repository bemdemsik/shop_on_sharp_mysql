CREATE DATABASE  IF NOT EXISTS `db60` /*!40100 DEFAULT CHARACTER SET utf8mb3 COLLATE utf8mb3_bin */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `db60`;
-- MySQL dump 10.13  Distrib 8.0.32, for Win64 (x86_64)
--
-- Host: 10.207.106.12    Database: db60
-- ------------------------------------------------------
...
INSERT INTO `categoryproduct` VALUES (1,'Кольца',0),(2,'Броши',49),(3,'Подвески и шармы',0),(4,'Серьги',0),(5,'Браслеты',0);
...
INSERT INTO `manufacturer` VALUES (1,'SOKOLOV'),(2,'Alexandra Gr'),(3,'Ювелирная студия Ильи Палкина'),(4,'BAUKOFF jewelry'),(5,'SILVERME'),(6,'POKROVSKY JEWELRY'),(7,'JeweLi'),(8,'Lamponi'),(9,'poemiq'),(10,'Голден Глоб'),(11,'Агра'),(12,'Золото Русских');
...
LOCK TABLES `ordersstructure` WRITE;
/*!40000 ALTER TABLE `ordersstructure` DISABLE KEYS */;
INSERT INTO `ordersstructure` VALUES (79,67,'147951219',1,'17292'),(80,68,'36012488',1,'1960'),(81,69,'147951219',1,'17292'),(82,70,'10589463',1,'17847');
...
INSERT INTO `pickuppoint` VALUES (1,'Балахна, ул. Горькова'),(2,'Заволжье'),(3,'Нижний Новгород'),(6,'Правдинск'),(7,'Новый'),(8,'ул. Коммунистическая'),(9,'ул. Космонавтов');
...
INSERT INTO `roleuser` VALUES (1,'Администратор'),(2,'Клиент'),(3,'Менеджер');
...
INSERT INTO `statusorder` VALUES (1,'Ожидается'),(2,'Получен'),(3,'Отменен'),(4,'Принят'),(5,'Отсортирован'),(6,'Оформлен');
...
-- Dump completed on 2023-05-29 15:46:33
